...
with gr.Blocks() as ui:
    ...
    user_input = gr.Textbox(label="Enter your Prompt",lines=3,max_lines=5,elem_classes="custom-input")
    token=gr.Textbox(label="Password Required",type="password",placeholder="your password",)
