...
def random_prompt():
    return random.choice([
        ...
        "Neck dose of iodine-131 treated patient is 20microSv and his Socio-economic factor(sef) is GOOD, can patient release recomended?.",
