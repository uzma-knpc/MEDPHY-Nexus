...
with gr.Blocks() as ui:
    ...
    gr.Markdown("<h1>MedicalPhysics-Nexus</h1>",unsafe_allow_html=True)#, unsafe_allow_html=True)

    gr.Markdown("<h1 style='text-align: center; color: blue;'>Generative AI Powered</h1>")
