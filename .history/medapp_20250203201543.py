...
with gr.Blocks() as ui:
    gr.Markdown(custom_css)#, unsafe_allow_html=True)  # Use custom CSS for styling
    ...
    # Footer text
    gr.Markdown("<p>Developed by Medical Physics Division(AEMCK)(</p>")#, unsafe_allow_html=True)
