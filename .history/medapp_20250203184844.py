...
with gr.Blocks() as ui:
    ...
    gr.Markdown("<p>Unit "An intelligent system for unit conversions, decay calculations, and the management of Iodine-treated patient releases. It ensures compliance with radiation protection regulations and medical physics standards, integrating all relevant safety limits and guidelines." </p>", unsafe_allow_html=True)
